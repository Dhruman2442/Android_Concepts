...
public class Notification extends AppCompatActivity {
    ...
    private void sendOnChannel1()  {
        ...
        android.app.Notification notification = new NotificationCompat.Builder(this, NotificationApp.CHANNEL_1_ID)
    ...
    private void sendOnChannel2()  {
        ...
        android.app.Notification notification = new NotificationCompat.Builder(this, NotificationApp.CHANNEL_2_ID)
                .setSmallIcon(R.drawable.logo_main)
                .setContentTitle(title)
                .setContentText(message)
